...
## 嗅觉阈值数据库
0.1.2版本已将《化合物嗅觉阈值汇编》（第二版，科学出版社）中物质在水中的嗅觉阈值整理成简易数据库，可通过CAS号快速查找物质对应的嗅觉阈值。
...
```
* [Releases](https://github.com/Funny1Potato/FP-DataHelper/releases)中有整合了Python3.10及全部所需模块的一键包，可以直接使用。
